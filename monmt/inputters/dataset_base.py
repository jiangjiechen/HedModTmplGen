...
class DatasetBase(torchtext.data.Dataset):
	...
	def __init__(self, fields, src_examples_iter, tmpl_examples_iter,
	             src2_examples_iter, tgt_examples_iter,
		...
		if tgt_examples_iter is not None:
			examples_iter = (self._join_dicts(src, tmpl, src2, tgt) for src, tmpl, src2, tgt in
			                 zip(src_examples_iter, tmpl_examples_iter,
			                     src2_examples_iter, tgt_examples_iter))
		elif src2_examples_iter is not None:
			examples_iter = (self._join_dicts(src, tmpl, src2) for src, tmpl, src2 in
			                 zip(src_examples_iter, tmpl_examples_iter, src2_examples_iter))
		elif tmpl_examples_iter is not None:
			examples_iter = (self._join_dicts(src, tmpl) for src, tmpl in
			                 zip(src_examples_iter, tmpl_examples_iter))
		else:
