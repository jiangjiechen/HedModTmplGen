...
class ServerModel:
    ...
    def parse_opt(self, opt):
        """Parse the option set passed by the user using `monmt.opts`
           Args:
        ...
        monmt.opts.translate_opts(parser)
    ...
    def load(self):
        ...
        if self.tokenizer_opt is not None:
            ...
            if self.tokenizer_opt['type'] == 'sentencepiece':
                ...
                sp.Load(model_path)
                self.tokenizer = sp
            elif self.tokenizer_opt['type'] == 'pymonmttok':
                ...
                tokenizer = pymonmttok.Tokenizer(mode,
                                                **tokenizer_params)
